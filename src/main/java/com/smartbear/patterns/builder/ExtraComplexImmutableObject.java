...
public class ExtraComplexImmutableObject implements ComplexImmutable
{
	...
	public boolean equals( Object o )
	{
		...
		if( !aspect.equals( that.aspect ) )
			return false;
		if( !compositeBehavior.equals( that.compositeBehavior ) )
			return false;
	...
	{
		return "ExtraComplexImmutableObject{" + "compositeBehavior=" + compositeBehavior + ", aspect='" + aspect + '\''
				+ '}';
	}
