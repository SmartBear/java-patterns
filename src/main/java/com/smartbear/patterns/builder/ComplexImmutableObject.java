...
public final class ComplexImmutableObject implements ComplexImmutable {
    ...
    ComplexImmutableObject(long timeout, boolean strict, String name, String nameSpace, String context, long initialValue) {
    ...
    private static final int computeHashCode(long timeout, boolean strict, String name, String nameSpace, String context, long initialValue){
